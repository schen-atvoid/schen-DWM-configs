...
run xrandr --output DP-0 --primary --mode 2560x1440 --pos 0x0 --rotate normal --output DP-1 --off --output HDMI-0 --off --output DP-2 --mode 1920x1080 --pos 208x1440 --rotate normal
